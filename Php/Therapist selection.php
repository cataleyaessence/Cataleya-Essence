...
error_log("Therapist Selection - Received category: " . $category);

// Validate category
if (!in_array($category, ['Beauty Services', 'Spa Massage'])) {
    $category = 'Beauty Services';
    error_log("Therapist Selection - Invalid category, defaulting to: " . $category);
}
...
<head>
    ...
    <title>Choose Your Therapist · Cataleya Essence</title>
...
<body>
    ...
    <main class="therapist-page">
        <a href="Calendar%20service.php" class="back-link"><i class="fas fa-arrow-left"></i> Back to Date &amp; Time</a>
        ...
        <div class="therapist-grid" id="therapistGrid">
            ...
            <?php else: ?>
                <?php foreach ($therapists as $therapist): ?>
                    <div class="therapist-card" data-type="<?php echo $categoryType; ?>" data-id="<?php echo $therapist['id']; ?>">
                        <div class="therapist-avatar">
                            <img src="<?php echo htmlspecialchars($therapist['image_url']); ?>" alt="<?php echo htmlspecialchars($therapist['full_name']); ?>" />
                        </div>
    ...
    <!-- ========== JAVASCRIPT ========== -->
    <script src="../JS/Therapist selection.js"></script>
</body>
</html>
