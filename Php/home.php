...
$first_day = new DateTime("$current_year-$current_month_num-01");
$last_day = new DateTime("$current_year-$current_month_num-" . $first_day->format('t'));
...
<body>
  ...
  <section class="hero">
    ...
    <div class="hero__left">
      ...
      <div class="hero__btns">
        <a href="serv.php" class="btn btn--solid">Book Appointment</a>
        <a href="serv.php" class="btn btn--ghost">View Services</a>
      </div>
    </div>
  ...
  <section class="services" id="services">
    ...
    <div class="services__cta">
      <a href="serv.php" class="btn-view-all">View all Services</a>
    </div>
    ...
    <section class="hall-of-fame" id="hall-of-fame">
        ...
        <div class="hall-of-fame__cta">
            <a href="Rewards.php" class="btn-hall-of-fame">View More</a>
        </div>
        ...
        <div class="availability__grid">
            ...
            <div class="calendar-card">
                <div class="calendar-header">
                    <button class="calendar-nav-btn calendar-prev" id="prevMonth"><i class="fas fa-chevron-left"></i></button>
                    <span class="calendar-month" id="calendarMonth"><?php echo strtoupper($current_month); ?></span>
                    <button class="calendar-nav-btn calendar-next" id="nextMonth"><i class="fas fa-chevron-right"></i></button>
                </div>
                <div class="calendar-body">
                    ...
                    <div class="calendar-dates" id="calendarDates">
                        <?php
                        $today = date('Y-m-d');
                        $first_day_offset = $first_day->format('w'); // 0 = Sunday, 6 = Saturday
                        ...
                        for ($day = 1; $day <= $days_in_month; $day++):
                            $date_str = sprintf('%04d-%02d-%02d', $current_year, $current_month_num, $day);
  ...
  <section class="wellness" id="about">
    ...
    <div class="wellness__card">
      <div class="wellness__card-avatar">
        <img src="../img/Owner.jpg" alt="Shiro Amawasa"
